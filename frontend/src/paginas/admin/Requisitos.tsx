...
export function Requisitos({ avisar }: { avisar: (m: string) => void }) {
  ...
  const camposDocumento: CampoCatalogo[] = [
    ...
    { clave: "vigenciaDias", titulo: "Vigencia (días)", tipo: "numero", ancho: 140 },
    { clave: "formatos", titulo: "Formatos", tipo: "texto", ancho: 150 },
    { clave: "tamanoMaxMb", titulo: "Máx. MB", tipo: "numero", ancho: 100 },
  ];
    ...
    <div style={{ display: "grid", gap: 16 }}>
      ...
      >
        {requisitos === null || documentos === null ? (
          ...
          <Tabla columnas={["Requisito", "Aplica a", "Se cumple con", "Documentos que lo soportan", "Activo"]}>
            {requisitos.map((r) => (
